...
#============================== STORAGE OPTMIZATION BACKEST==========================================================#
    ...
    def _calculate_storage_costs(self):
        ...
        print("Each MWh of storage capacity costs €0.0031 per day")
...
#=================================== Rolling Intrinsic Value ================================================#    
    ...
    def calculate_rolling_intrinsic_value_with_costs(self):        
        ...
        print(f"📅 PERIODS: - Trading={trading_start_date.date()} to {storage_allocation_start.date()}")
        print(f"             - Storage Allocation={storage_allocation_start.date()} to {storage_allocation_end.date()}")
